...
class _ToDo4924EditableScreen extends State<ToDo4924EditableScreen> {
  ...
  _initialValue= {
    ...
    'datumzavrsenja': widget.todo4924?.datumzavrsenja!.toIso8601String().substring(0,10)??"nije postavljen", 
          ...
          Row(
            children: [
              ElevatedButton(onPressed: () async{
                  ...
                  }, child: const Text("Osvježi aktivnosti")),
            ],
          ),
             ...
             Row(
               children: [
                 ElevatedButton(onPressed: () async{
                           showDialog(context: context, builder: (BuildContext context) => 
                        AlertDialog(
                          title: const Text("Realizuj!!!"),
                          content: Text("Da li ste sigurni da želite označiti aktivnost kao reliziranu? ${widget.todo4924!.todo4924id}?"),
                          actions: [
                        ...
                        AlertDialog(
                          ...
                          content: Text("Da li ste sigurni da želite označiti aktivnost kao isteklu? ${widget.todo4924!.todo4924id}?"),
                          actions: [
